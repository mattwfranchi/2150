...
public interface IMortgage {
    // MIN AND MAX BOUNDS - ADDED FOR LAB 9
    int MINCREDIT = 0;
    // MAXCREDIT already added below
    double MINHOUSECOST = 0.0;
    double MINDOWNPAYMENT = 0.0;
    int MINNUMYEARS = 0;
    double MININCOME = 0;
    double MINDEBT = 0;

    //Helpful comparisons for credit scores
    public static int BADCREDIT = 500;
    int FAIRCREDIT = 600;
    int GOODCREDIT = 700;
    int GREATCREDIT = 750;
    int MAXCREDIT = 850;
    ...
    double LESSTHAN30RATE = 0.005;
    double GREATERTHAN30RATE = .01;


    double SMALLPDRATE = .005;
